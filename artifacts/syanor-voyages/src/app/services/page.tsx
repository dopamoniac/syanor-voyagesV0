...
const blocks: ServiceBlock[] = [
  ...
  },
  {
    ...
    badge: "Voyage spirituel",
    overlayTint: "rgba(60,28,6,0.65)",
  },
  {
    id: "packs",
    ...
    badge: "Expérience sacrée",
    overlayTint: "rgba(65,30,5,0.68)",
  },
  {
              ...
              >
                ...
                <div className="relative h-44 shrink-0 overflow-hidden">
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(170deg, transparent 20%, ${b.overlayTint} 100%)`,
                    }}
                    aria-hidden="true"
                  />
                  {/* Icon — top right */}
                  ...
                  <div
                    ...
                    style={{
                      background: "linear-gradient(to right, rgba(201,162,74,0.80), rgba(201,162,74,0.10))",
                    }}
                    aria-hidden="true"
                  />
                </div>
                  ...
                  <ul className="mt-4 flex-1 space-y-1.5 text-sm text-syanor-ink/70">
                    {b.points.map((p) => (
                      <li key={p} className="flex items-center gap-2.5">
                        <span className="shrink-0 text-[0.65rem] text-syanor-gold" aria-hidden="true">
                          ✦
                        </span>
                        {p}
                      </li>
            ...
            <Reveal key={f.title} delay={(i % 4) * 60}>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    width: "1.5rem",
                    background: "linear-gradient(to right, rgba(201,162,74,0.45), transparent)",
                  }}
                  aria-hidden="true"
                />
