...
const faqItems = [
  {
    ...
    answer: "Non. Notre accompagnement s'adresse à tous nos voyageurs spirituels (Omra, Hajj, Omra Plus, Ramadan) et s'adapte à votre formule.",
  },
  {
    question: "Quand débute la préparation ?",
    answer: "La préparation commence avant le départ, se poursuit pendant les rites et se prolonge par un suivi après le retour.",
  },
  {
...
export default function OmraFormationsPage() {
  return (
    <OmraFactoryLayout>
      <PageHero
        ...
        crumbs={[{ label: "Omra Factory", href: "/omra-factory" }, { label: "Formation" }]}
        primaryCta={{ label: "Être accompagné", href: quoteHref }}
        secondaryCta={{ label: "Nos programmes", href: "/omra-factory" }}
      />
