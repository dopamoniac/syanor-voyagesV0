...
export const metadata: Metadata = {
  title: "Assistance Visa Omra & Arabie Saoudite | SYANOR VOYAGES",
  description:
    "Visa Omra et visa touristique Arabie Saoudite : documents requis, démarches, délais et erreurs à éviter. Assistance visa incluse dans nos formules Omra.",
...
const documents = [
  ...
  { icon: "🏨", title: "Réservation hôtel", detail: "Confirmations hôtel Médine et Makkah" },
];
...
const steps = [
  ...
  { step: "5", title: "Remise du visa", desc: "Votre visa Omra vous est transmis avant le départ. Vous voyagez sereinement." },
];
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        crumbs={[{ label: "Accueil", href: "/" }, { label: "Visas" }]}
        primaryCta={{ label: "Demander l'assistance visa", href: quoteUrl({ service: "Omra" }) }}
      />
      ...
      <section className="section-pad bg-syanor-ivory">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <SectionHeader
            ...
            title="Visa Omra ou visa touristique ?"
            subtitle="Deux options existent pour se rendre en Arabie Saoudite. Le visa Omra est spécifique à la pratique religieuse et généralement requis pour les formules organisées."
          />
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border-2 border-syanor-gold/50 bg-syanor-pearl p-6 shadow-gold">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h3 className="font-playfair text-lg font-bold text-syanor-ink">Visa Omra</h3>
              </div>
              <p className="text-sm text-syanor-ink/70">
                Délivré spécifiquement pour accomplir la Omra. Obtenu via une agence de voyage agréée. Valable pour la durée du séjour. Inclus dans toutes nos formules Omra.
              </p>
            ...
            <div className="rounded-2xl border border-syanor-gold/20 bg-white p-6 shadow-card">
              ...
              <p className="text-sm text-syanor-ink/70">
                Depuis 2019, l'Arabie Saoudite délivre un visa touristique électronique permettant également la pratique de la Omra. Plus souple mais spécificités à vérifier.
              </p>
              <ul className="mt-4 space-y-2 text-sm text-syanor-ink/70">
      ...
      <section className="section-pad bg-white">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <SectionHeader
            ...
            title="Ce qu'il vous faut pour le visa Omra"
        ...
        <div className="mx-auto max-w-3xl px-6 md:px-8">
          ...
          <ul className="mt-10 space-y-4">
            {[
              ...
              { title: "Photos non conformes", detail: "Les photos saoudiennes ont des normes précises (fond blanc pur, visage dégagé, taille exacte). Les photos de supermarché sont souvent refusées." },
              { title: "Vaccination périmée", detail: "Le vaccin contre la méningocoque doit être récent. Vérifiez la date limite sur votre carnet de santé." },
              { title: "Dossier soumis trop tard", detail: "Nous recommandons de soumettre le dossier au moins 3 semaines avant le départ. En période de forte demande (Ramadan), comptez 4 à 6 semaines." },
              { title: "Documents incomplets", detail: "Un dossier incomplet retarde tout le groupe. SYANOR vérifie chaque pièce avant soumission." },
            ].map((item) => (
      ...
      <section className="section-pad bg-syanor-ivory">
        <div className="mx-auto max-w-3xl px-6 md:px-8">
          <SectionHeader eyebrow="FAQ Visa" title="Questions fréquentes sur le visa Omra" />
          <div className="mt-10 space-y-4">
            {[
              { q: "L'assistance visa est-elle payante ?", a: "L'assistance visa est incluse dans toutes nos formules Omra. Il n'y a pas de frais supplémentaires pour la constitution du dossier. Les frais de visa officiels peuvent s'appliquer selon les cas." },
              { q: "Puis-je faire ma demande de visa moi-même ?", a: "Techniquement oui, mais nous déconseillons fortement cette approche pour la Omra. Le visa Omra est obtenu via un circuit officiel d'agences agréées. SYANOR gère ce processus pour vous garantir un dossier conforme." },
              { q: "Combien de temps faut-il pour obtenir le visa ?", a: "En général 5 à 10 jours ouvrés hors périodes de forte demande. Pendant le Ramadan, comptez 15 à 20 jours ouvrés. Nous vous conseillons de ne pas attendre le dernier moment." },
              ...
              { q: "Les femmes ont-elles des conditions particulières ?", a: "Les femmes de moins de 45 ans voyageant en groupe organisé n'ont généralement pas besoin de mahram. Les conditions exactes dépendent de la nationalité et peuvent évoluer. SYANOR vous informe des exigences en vigueur." },
            ].map(({ q, a }) => (
