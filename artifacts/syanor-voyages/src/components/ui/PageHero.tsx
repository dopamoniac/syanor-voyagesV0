...
function ServicesVisual() {
  ...
  return (
    <div className="relative flex h-[460px] w-[420px] items-center justify-center">
      <div className="pointer-events-none absolute inset-0 rounded-full opacity-20" style={{ background: "radial-gradient(circle at 50% 50%, rgba(201,162,74,0.35), transparent 65%)" }} aria-hidden="true" />
      <div className="relative z-10 grid grid-cols-3 gap-3">
        {cards.map((card, i) => (
          <div key={card.label} className="flex flex-col items-center gap-2 rounded-xl p-4" style={{ background: "rgba(255,249,237,0.04)", border: "1px solid rgba(201,162,74,0.18)", backdropFilter: "blur(8px)", boxShadow: "0 4px 24px rgba(0,0,0,0.25)", transform: i === 1 || i === 4 ? "translateY(-6px)" : i === 2 ? "translateY(4px)" : "none" }} aria-hidden="true">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg text-lg" style={{ background: "linear-gradient(135deg, rgba(201,162,74,0.22), rgba(201,162,74,0.08))", border: "1px solid rgba(201,162,74,0.35)", color: "#C9A24A", fontSize: "1.1rem" }}>{card.symbol}</div>
      ...
      <div className="pointer-events-none absolute bottom-6 left-1/2 -translate-x-1/2 rounded-full px-4 py-1.5 text-[0.63rem] font-semibold text-syanor-gold" style={{ background: "rgba(201,162,74,0.08)", border: "1px solid rgba(201,162,74,0.25)" }} aria-hidden="true">
...
function RoutesVisual() {
  return (
    <div className="relative flex h-[460px] w-[420px] items-center justify-center" aria-hidden="true">
      <div className="pointer-events-none absolute inset-0 opacity-15" style={{ background: "radial-gradient(ellipse at 50% 60%, rgba(201,162,74,0.40), transparent 65%)" }} />
      <div className="relative z-10 flex w-full flex-col items-center gap-0">
        <svg viewBox="0 0 400 200" className="w-full max-w-[380px]">
          <path d="M 55 160 Q 200 30 345 160" fill="none" stroke="rgba(201,162,74,0.20)" strokeWidth="1.5" strokeDasharray="5 4" />
          <path d="M 55 160 Q 200 30 345 160" fill="none" stroke="rgba(201,162,74,0.50)" strokeWidth="0.75" />
        ...
        <div className="mt-3 flex gap-2.5">
          {["Oct", "Nov", "Déc", "Jan", "Fév"].map((m) => (
            <div key={m} className="rounded-full px-3 py-1 text-[0.60rem] font-semibold" style={{ background: "rgba(255,249,237,0.05)", border: "1px solid rgba(255,249,237,0.12)", color: "rgba(255,249,237,0.50)" }}>{m}</div>
          ))}
        </div>
        <div className="mt-5 flex gap-3">
          <div className="flex items-center gap-1.5 rounded-xl px-3.5 py-2 text-[0.62rem]" style={{ background: "rgba(201,162,74,0.08)", border: "1px solid rgba(201,162,74,0.22)" }}>
            <span style={{ color: "#C9A24A" }}>✈</span>
            <span className="font-semibold text-syanor-champagne/80">Vols directs</span>
          </div>
          <div className="flex items-center gap-1.5 rounded-xl px-3.5 py-2 text-[0.62rem]" style={{ background: "rgba(255,249,237,0.04)", border: "1px solid rgba(255,249,237,0.12)" }}>
...
function EditorialVisual() {
  ...
  return (
    <div className="relative flex h-[460px] w-[400px] flex-col items-start justify-center gap-3.5 pl-2" aria-hidden="true">
      <div className="pointer-events-none absolute -left-8 top-0 h-full w-1 opacity-30" style={{ background: "linear-gradient(to bottom, transparent, rgba(201,162,74,0.60) 30%, rgba(201,162,74,0.60) 70%, transparent)" }} />
      ...
      {articles.map((a, i) => (
        <div key={a.title} className="w-full rounded-xl p-4" style={{ background: i === 0 ? "rgba(255,249,237,0.06)" : "rgba(255,249,237,0.03)", border: i === 0 ? "1px solid rgba(201,162,74,0.25)" : "1px solid rgba(255,249,237,0.08)", opacity: i === 0 ? 1 : i === 1 ? 0.75 : 0.50, transform: `translateX(${i * 8}px)` }}>
          <div className="mb-2 flex items-center gap-2">
            <span className="rounded-full px-2 py-0.5 text-[0.58rem] font-bold uppercase tracking-[0.10em]" style={{ background: "rgba(201,162,74,0.10)", color: a.catColor, border: `1px solid ${a.catColor}30` }}>{a.cat}</span>
          </div>
...
function IdentityVisual() {
  return (
    <div className="relative flex h-[460px] w-[420px] items-center justify-center" aria-hidden="true">
      <div className="pointer-events-none absolute inset-0 opacity-20" style={{ background: "radial-gradient(circle at 50% 48%, rgba(201,162,74,0.40), transparent 65%)" }} />
      <div className="relative z-10 flex flex-col items-center gap-6">
        <div className="relative flex items-center justify-center">
          <svg viewBox="0 0 280 280" width="240" height="240">
            ...
            <text fontSize="11" fontFamily="'Playfair Display', serif" fontWeight="700" fill="rgba(201,162,74,0.80)" letterSpacing="0.22em"><textPath href="#top-arc" startOffset="10%">SYANOR VOYAGES</textPath></text>
            <path id="bot-arc" d="M 55 200 A 112 112 0 0 0 225 200" fill="none" />
            <text fontSize="8.5" fontFamily="'Inter', sans-serif" fill="rgba(255,249,237,0.35)" letterSpacing="0.24em"><textPath href="#bot-arc" startOffset="8%">AGENCE DE VOYAGES PREMIUM</textPath></text>
            ...
            {[0, 90, 180, 270].map((deg) => (
              <circle key={deg} cx={140 + 130 * Math.sin((deg * Math.PI) / 180)} cy={140 - 130 * Math.cos((deg * Math.PI) / 180)} r="3" fill="rgba(201,162,74,0.50)" />
            ))}
          </svg>
        </div>
        <div className="flex gap-2.5">
          {["Expertise", "Confiance", "Excellence"].map((v) => (
            <div key={v} className="rounded-full px-3.5 py-1.5 text-[0.60rem] font-semibold uppercase tracking-[0.10em]" style={{ background: "rgba(201,162,74,0.08)", border: "1px solid rgba(201,162,74,0.22)", color: "rgba(201,162,74,0.75)" }}>{v}</div>
          ))}
        </div>
      </div>
    </div>
...
function SpiritualVisual() {
  return (
    <div className="relative flex h-[460px] w-[420px] items-center justify-center" aria-hidden="true">
      <div className="pointer-events-none absolute inset-0 opacity-25" style={{ background: "radial-gradient(circle at 50% 50%, rgba(201,162,74,0.35), transparent 60%)" }} />
      <div className="relative z-10 flex flex-col items-center gap-5">
        <svg viewBox="0 0 300 300" width="280" height="280">
          <polygon points="150,20 220,60 260,130 260,170 220,240 150,280 80,240 40,170 40,130 80,60" fill="none" stroke="rgba(201,162,74,0.20)" strokeWidth="1" />
          <polygon points="150,42 206,72 236,128 236,172 206,228 150,258 94,228 64,172 64,128 94,72" fill="none" stroke="rgba(201,162,74,0.12)" strokeWidth="0.75" transform="rotate(22.5 150 150)" />
          <polygon points="150,55 163,118 220,100 178,148 220,196 163,178 150,242 137,178 80,196 122,148 80,100 137,118" fill="none" stroke="rgba(201,162,74,0.35)" strokeWidth="1" />
          ...
          {[0, 45, 90, 135, 180, 225, 270, 315].map((deg) => (
            <circle key={deg} cx={150 + 130 * Math.sin((deg * Math.PI) / 180)} cy={150 - 130 * Math.cos((deg * Math.PI) / 180)} r="2.5" fill={deg % 90 === 0 ? "rgba(201,162,74,0.60)" : "rgba(201,162,74,0.25)"} />
          ))}
        </svg>
        <div className="flex gap-3">
          {["Omra", "Hajj", "Ziyarat", "Formation"].map((v) => (
            <div key={v} className="rounded-full px-3 py-1 text-[0.60rem] font-semibold" style={{ background: "rgba(201,162,74,0.08)", border: "1px solid rgba(201,162,74,0.22)", color: "rgba(201,162,74,0.75)" }}>{v}</div>
          ))}
        </div>
      </div>
    </div>
...
function DefaultOrnament() {
  return (
    <div className="relative flex h-[420px] w-[400px] items-center justify-center" aria-hidden="true">
      <div className="pointer-events-none absolute inset-0 opacity-15" style={{ background: "radial-gradient(circle, rgba(201,162,74,0.40), transparent 65%)" }} />
...
function MobileImageStrip({ image }: { image: string }) {
  return (
    <div
      ...
      style={{ height: "200px", border: "1px solid rgba(201,162,74,0.25)", boxShadow: "0 16px 40px rgba(0,0,0,0.40)" }}
      aria-hidden="true"
    >
      <img src={image} alt="" className="h-full w-full object-cover" loading="eager" />
      <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, rgba(2,43,36,0.50) 0%, transparent 35%, transparent 55%, rgba(2,43,36,0.45) 100%)" }} />
      <div className="absolute bottom-2.5 right-2.5 opacity-50">
        <svg viewBox="0 0 40 40" width="36" height="36" fill="none">
          <path d="M40 0 Q40 40 0 40" stroke="rgba(201,162,74,0.7)" strokeWidth="1" />
          <circle cx="40" cy="40" r="2" fill="rgba(201,162,74,0.6)" />
        </svg>
      </div>
    </div>
  );
...
function MobileServicesVisual() {
  ...
  return (
    <div className="grid grid-cols-3 gap-2" aria-hidden="true">
      {cards.map((c, i) => (
        <div key={c.label} className="flex flex-col items-center gap-2 rounded-xl px-2 py-3" style={{ background: "rgba(255,249,237,0.04)", border: "1px solid rgba(201,162,74,0.15)", opacity: i >= 3 ? 0.60 : 1 }}>
          <div className="flex h-9 w-9 items-center justify-center rounded-lg" style={{ background: "linear-gradient(135deg, rgba(201,162,74,0.20), rgba(201,162,74,0.07))", border: "1px solid rgba(201,162,74,0.30)", color: "#C9A24A", fontSize: "1rem" }}>{c.symbol}</div>
          <p className="text-center text-[0.57rem] font-bold uppercase tracking-[0.08em] text-syanor-champagne/80">{c.label}</p>
        </div>
      ))}
    </div>
  );
...
function MobileRoutesVisual() {
  return (
    <div
      ...
      style={{ background: "rgba(255,249,237,0.03)", border: "1px solid rgba(201,162,74,0.15)", padding: "14px 12px 12px" }}
      aria-hidden="true"
    >
      <svg viewBox="0 0 340 96" width="100%" style={{ display: "block" }}>
        <path d="M 30 72 Q 170 10 310 72" fill="none" stroke="rgba(201,162,74,0.20)" strokeWidth="1.5" strokeDasharray="5 4" />
        <path d="M 30 72 Q 170 10 310 72" fill="none" stroke="rgba(201,162,74,0.50)" strokeWidth="0.75" />
        <circle cx="30" cy="72" r="5" fill="rgba(201,162,74,0.20)" stroke="rgba(201,162,74,0.65)" strokeWidth="1.5" />
        <circle cx="30" cy="72" r="2" fill="rgba(201,162,74,0.90)" />
        <circle cx="310" cy="72" r="5" fill="rgba(201,162,74,0.20)" stroke="rgba(201,162,74,0.65)" strokeWidth="1.5" />
        <circle cx="310" cy="72" r="2" fill="rgba(201,162,74,0.90)" />
        <g transform="translate(170,17) rotate(-2)">
          <polygon points="0,-7 13,0 0,3.5 3,0" fill="rgba(201,162,74,0.85)" />
        </g>
        <text x="30" y="88" textAnchor="middle" fill="rgba(255,249,237,0.50)" fontSize="8" fontFamily="Inter, sans-serif" fontWeight="600">Nice / Marseille</text>
        <text x="310" y="88" textAnchor="middle" fill="rgba(255,249,237,0.50)" fontSize="8" fontFamily="Inter, sans-serif" fontWeight="600">Jeddah</text>
        <rect x="135" y="2" width="70" height="14" rx="7" fill="rgba(201,162,74,0.10)" stroke="rgba(201,162,74,0.25)" strokeWidth="0.75" />
        <text x="170" y="12" textAnchor="middle" fill="rgba(201,162,74,0.80)" fontSize="7" fontFamily="Inter, sans-serif" fontWeight="600">≈ 3 900 KM</text>
      </svg>
      <div className="mt-2 flex flex-wrap justify-center gap-1.5">
        {["Oct", "Nov", "Déc", "Jan", "Fév"].map((m) => (
          <div key={m} className="rounded-full px-2.5 py-0.5 text-[0.57rem] font-semibold" style={{ background: "rgba(255,249,237,0.04)", border: "1px solid rgba(255,249,237,0.10)", color: "rgba(255,249,237,0.45)" }}>{m}</div>
        ))}
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col gap-2" aria-hidden="true">
      <div className="mb-0.5 flex items-center gap-2">
        <div className="h-px w-6 bg-syanor-gold/35" />
        <span className="text-[0.57rem] font-bold uppercase tracking-[0.16em] text-syanor-gold/60">Le magazine SYANOR</span>
      </div>
      {articles.map((a, i) => (
        <div key={a.title} className="rounded-xl p-3.5" style={{ background: "rgba(255,249,237,0.04)", border: "1px solid rgba(201,162,74,0.18)", opacity: i === 0 ? 1 : 0.65 }}>
          <span className="mb-1.5 inline-block rounded-full px-2 py-0.5 text-[0.55rem] font-bold uppercase tracking-[0.10em]" style={{ background: "rgba(201,162,74,0.10)", color: "#C9A24A", border: "1px solid rgba(201,162,74,0.22)" }}>{a.cat}</span>
          <p className="text-[0.70rem] font-semibold leading-snug text-syanor-champagne/85">{a.title}</p>
          <p className="mt-1 text-[0.58rem] text-syanor-champagne/40">{a.meta}</p>
        </div>
      ))}
    </div>
  );
  ...
  return (
    <div className="flex flex-col items-center gap-3" aria-hidden="true">
      <svg viewBox="0 0 200 200" width="160" height="160">
        <circle cx="100" cy="100" r="90" fill="none" stroke="rgba(201,162,74,0.25)" strokeWidth="1" />
        <circle cx="100" cy="100" r="80" fill="none" stroke="rgba(201,162,74,0.12)" strokeWidth="0.75" strokeDasharray="3 4" />
        <path id="top-arc-m" d="M 18 100 A 82 82 0 0 1 182 100" fill="none" />
        <text fontSize="8.5" fontFamily="'Playfair Display', serif" fontWeight="700" fill="rgba(201,162,74,0.80)" letterSpacing="0.20em">
        ...
        <text fontSize="6.5" fontFamily="Inter, sans-serif" fill="rgba(255,249,237,0.30)" letterSpacing="0.18em">
          <textPath href="#bot-arc-m" startOffset="5%">AGENCE DE VOYAGES PREMIUM</textPath>
        </text>
        <polygon points="100,42 130,100 100,158 70,100" fill="none" stroke="rgba(201,162,74,0.28)" strokeWidth="1" />
        <text x="100" y="112" textAnchor="middle" fontFamily="'Playfair Display', serif" fontWeight="700" fontSize="34" fill="rgba(201,162,74,0.70)">S</text>
        {[0, 90, 180, 270].map((deg) => (
          <circle key={deg} cx={100 + 90 * Math.sin((deg * Math.PI) / 180)} cy={100 - 90 * Math.cos((deg * Math.PI) / 180)} r="3" fill="rgba(201,162,74,0.50)" />
        ))}
      </svg>
      <div className="flex gap-2">
        {["Expertise", "Confiance", "Excellence"].map((v) => (
          <div key={v} className="rounded-full px-2.5 py-1 text-[0.56rem] font-semibold uppercase tracking-[0.08em]" style={{ background: "rgba(201,162,74,0.08)", border: "1px solid rgba(201,162,74,0.20)", color: "rgba(201,162,74,0.70)" }}>{v}</div>
        ))}
      </div>
    </div>
  );
...
function MobileSpiritualVisual() {
  return (
    <div className="flex justify-center" aria-hidden="true">
      <svg viewBox="0 0 200 200" width="160" height="160">
        <polygon points="100,8 124,60 180,76 140,116 148,174 100,148 52,174 60,116 20,76 76,60" fill="none" stroke="rgba(201,162,74,0.35)" strokeWidth="1" />
        <polygon points="100,24 118,70 168,84 132,118 140,166 100,142 60,166 68,118 32,84 82,70" fill="none" stroke="rgba(201,162,74,0.16)" strokeWidth="0.75" transform="rotate(22.5 100 100)" />
        <circle cx="100" cy="100" r="36" fill="rgba(255,249,237,0.02)" stroke="rgba(201,162,74,0.28)" strokeWidth="1" />
        <path d="M 90 86 Q 100 76 110 86 Q 107 98 100 108 Q 93 98 90 86 Z" fill="rgba(201,162,74,0.62)" />
        <circle cx="113" cy="83" r="3" fill="none" stroke="rgba(201,162,74,0.60)" strokeWidth="1" />
        <circle cx="116" cy="83" r="1.3" fill="rgba(201,162,74,0.70)" />
        {[0, 45, 90, 135, 180, 225, 270, 315].map((deg) => (
          <circle key={deg} cx={100 + 88 * Math.sin((deg * Math.PI) / 180)} cy={100 - 88 * Math.cos((deg * Math.PI) / 180)} r="2" fill={deg % 90 === 0 ? "rgba(201,162,74,0.60)" : "rgba(201,162,74,0.20)"} />
        ))}
      </svg>
    </div>
  );
  ...
  return (
    <div className="flex justify-center" aria-hidden="true">
      <svg viewBox="0 0 140 140" width="120" height="120">
        <polygon points="70,5 135,70 70,135 5,70" fill="none" stroke="rgba(201,162,74,0.28)" strokeWidth="1" />
        <polygon points="70,20 120,70 70,120 20,70" fill="none" stroke="rgba(201,162,74,0.15)" strokeWidth="0.75" />
        <circle cx="70" cy="70" r="18" fill="none" stroke="rgba(201,162,74,0.28)" strokeWidth="1" />
        <circle cx="70" cy="70" r="3" fill="rgba(201,162,74,0.60)" />
        {[[70, 5], [135, 70], [70, 135], [5, 70]].map(([cx, cy]) => (
          <circle key={`${cx}-${cy}`} cx={cx} cy={cy} r="2.5" fill="rgba(201,162,74,0.50)" />
        ))}
      </svg>
    </div>
  );
...
export default function PageHero({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl items-center px-6 py-20 md:px-8 lg:py-0">
        <div className="grid w-full grid-cols-1 gap-0 lg:grid-cols-[1fr_420px] lg:gap-16 xl:grid-cols-[1fr_480px]">
          ...
          <div className="flex flex-col justify-center">
            ...
            {eyebrow && (
              <div className="mb-5 inline-flex">
                <span
                  ...
                  style={{ background: "rgba(201,162,74,0.12)", border: "1px solid rgba(201,162,74,0.35)", color: "#C9A24A" }}
                >
            ...
            {/* ── Mobile visual — shown below CTAs on small screens only ── */}
          ...
          {/* overflow-hidden prevents fixed-width children from widening scroll */}
            ...
            {image ? (
              <div className="relative w-full">
                ...
                >
                  ...
                  <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(2,43,36,0.55) 0%, transparent 50%)" }} aria-hidden="true" />
                </div>
      ...
      {/* ── Bottom fade ── */}
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-24" style={{ background: "linear-gradient(to bottom, transparent, rgba(2,43,36,0.6))" }} aria-hidden="true" />
