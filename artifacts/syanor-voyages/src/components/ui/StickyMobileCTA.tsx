      ...
      <div className="flex gap-2">
        ...
        {whatsapp && (
          <a
            ...
            aria-label="WhatsApp"
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-syanor-gold/30 text-syanor-emerald transition hover:border-syanor-gold hover:text-syanor-gold"
          >
