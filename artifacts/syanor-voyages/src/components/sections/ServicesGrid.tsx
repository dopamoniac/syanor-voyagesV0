...
const GROUPS: ServiceGroup[] = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        href: "/agence/services/billets-groupe",
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        href: "/agence/services/pack-premium-vip",
      ...
      },
      {
        ...
        href: "/agence/services/voyages-de-noces",
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        badge: "5★ Sélection",
        desc: "Hôtels 4–5★ sélectionnés et transferts privés, aéroport & tout le séjour",
        href: "/agence/services/hotel-transferts",
      },
      {
        icon: "bus",
        title: "Voyages de Noces",
        badge: "Lune de miel",
        desc: "Destination romantique, villa ou suite 5★, surprises incluses",
        href: "/agence/services/voyages-de-noces",
      },
      {
        icon: "sparkle",
        ...
        badge: "Conciergerie",
        desc: "Coordination, dossier vérifié, interlocuteur dédié avant et pendant le voyage",
        href: "/agence/services/assistance-voyages",
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        badge: "Visa Europe & monde",
        desc: "Visa Schengen, USA, Canada, Turquie — dossier complet, suivi jusqu'à obtention",
        href: "/agence/visas",
        image: "/services/assistance-visa.png",
        alt: "Passeport et dossier visa Schengen SYANOR",
      },
      {
        icon: "building",
        title: "Hôtels & Transferts",
        badge: "Toutes destinations",
        desc: "Hôtels 4–5★ sélectionnés, transferts aéroport et port, Europe & monde",
        href: "/agence/services/hotel-transferts",
        image: "/services/assistance-visa.png",
      ...
      },
      {
        ...
        badge: "Multi-risques",
        desc: "Couverture annulation, médicale & rapatriement — toutes destinations civiles",
        href: "/agence/contact?service=Assurance#quote",
        image: "/services/assurance-voyage.png",
        alt: "Assurance voyage multi-risques",
      },
    ],
  },
];
